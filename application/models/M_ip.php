...
class M_ip extends CI_Model {
    ...
    var $column_order = array('Nama','Keterangan',"Bobot"); //field yang ada di table peserta
    var $column_search = array('Nama','Keterangan',"Bobot"); //field yang diizin untuk pencarian 
