...
class M_fakultas extends CI_Model {
    ...
    var $table = 'tbl_fakultas'; //nama tabel dari database
    var $column_order = array('Nama','Keterangan'); //field yang ada di table peserta
    ...
    function get_data($Id){
        $this->db->where("Id",$Id);
        return $this->db->get("tbl_fakultas")->row();
    }
    
    function cek_duplicate($Username){
        $this->db->where("Username",$Username);
        return $this->db->get("tbl_fakultas")->num_rows();
    }
