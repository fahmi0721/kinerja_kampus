                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                ...
                                <div class='input-group'>
                                    ...
                                    <input disabled  class='form-control FormInput' type='text' autocomplete='off' value='DIREKTUR SDM, UMUM & KEUANGAN'>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class='input-group'>
                                    ...
                                    <input disabled  class='form-control FormInput' type='text' autocomplete='off' value='MANAGER KEUANGAN'>
                                ...
                                <div class='input-group'>
                                    ...
                                    <input disabled  class='form-control FormInput' type='text' autocomplete='off' value='MANAGER SDM & UMUM'>
                                ...
                                <div class='input-group'>
                                    ...
                                    <input disabled  class='form-control FormInput'  type='text' autocomplete='off' value='MANAGER OPERASI & KOMERSIAL'>
