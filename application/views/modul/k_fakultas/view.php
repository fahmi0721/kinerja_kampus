  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Modul K-Fakultas
        <small>Data K-Fakultas</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?= base_url() ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Data K-Fakultas</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-danger">
        <div class="box-header with-border">
          <h3 class="box-title">Data K-Fakultas</h3>

          <div class="box-tools pull-right">
            <div class='btn-group' id='BtnControl'>
                <a href="<?= base_url('k_fakultas/tambah/'); ?>" class='btn btn-sm btn-primary' title='Tambah Data' data-toggle='tooltip'><i class='fa fa-plus'></i> Tambah</a>
...
<?php $this->load->view('modul/k_fakultas/view_js'); ?>