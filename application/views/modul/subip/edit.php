    ...
    <section class="content">
      ...
      <div class="box box-danger">
        <div class="box-header with-border">
          <h3 class="box-title">Ubah Sub Indikator Kinerja</h3>
                    ...
                    <div class='col-sm-9 col-md-8'>
                        ...
                        <div class="form-group">
                                    ...
                                    <?php 
                                        if(count($Ip) > 0){
                                            foreach($Ip as $key => $idataIp){
                                                $sel = $data->IdIp == $idataIp['Id'] ? "selected" : "";
                                                echo "<option value='".$idataIp['Id']."' ".$sel.">".$idataIp['Nama']."</option>";
                                            }
                                        }
                                    ?>
                                </select>
                            ...
                            <div class='col-sm-6'>
                                ...
                                <input class='form-control FormInput' value="<?= $data->Nama ?>" type='text' autocomplete='off' placeholder='Nama' name='Nama' id='Nama' placeholder="Nama  Sub Indikator">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class='col-sm-6'>
                                ...
                                <div class="input-group">
                                    <span class='input-group-addon'><input type="radio" name='KeyData' id="KeyData0" value='0' <?php if($data->KeyData === "0"){ echo "checked"; } ?>></span>
                                    <input type="text" class='form-control' readonly value="Tidak">
                                    <span class='input-group-addon'><input type="radio" name='KeyData' id="KeyData1" value='1' <?php if($data->KeyData === "1"){ echo "checked"; } ?>></span>
  ...
  <?php $this->load->view('modul/subip/edit_js'); ?>
